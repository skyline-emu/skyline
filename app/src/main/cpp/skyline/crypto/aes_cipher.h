...
namespace skyline::crypto {
    ...
    class AesCipher {
      ...
      public:
        AesCipher(const std::span<u8> &key, mbedtls_cipher_type_t type);
         ...
         */
        inline void Decrypt(const std::span<u8> &data) {
         ...
         */
        inline void XtsDecrypt(const std::span<u8> &data, size_t sector, size_t sectorSize) {
